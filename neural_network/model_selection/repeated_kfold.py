...
@export
class RepeatedKFold(KFold, MetadataMixin, SaveMixin):
    '''
    ...
    def __init__(self, n_splits: int = 5, n_repeats: int = 10,
        ...
        '''
        Initiliase the Repeated K-Fold Spliterator
    ...
    def split(self, X: Union[np.ndarray, list, tuple]) -> tuple:
        '''
        Iterator that performs repeated K-Fold split over the given array
        ...
        for i in range(self.n_repeats):
            for train, validate in super().split(X):
